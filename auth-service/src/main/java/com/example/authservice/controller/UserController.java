...
import com.example.authservice.response.UserLoginResponse;
...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<UserResponse> login(@RequestBody UserDto loginRequest) throws UserNotLoginException {
        UserResponse login =userService.login(loginRequest);
